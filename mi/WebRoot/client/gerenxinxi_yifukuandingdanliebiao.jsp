...
<div id="indexNum02">
	<div class="index-head clearfix">
		...
		<center><span class="s_title">已付款订单</span> </center>
		<div class="right">
			<a href="" class="a1 cart" title="购物车"></a>
		</div>
		<center><a href="../ordersServlet?action=queryOrdersByUsersIsPayAndOrderByOrd_status&orderBy=1">降序</a>　　　　
				<a href="../ordersServlet?action=queryOrdersByUsersIsPayAndOrderByOrd_status&orderBy=2">升序</a></center>
...
<div id="goods_list">
	<div class="centerNum20150618">
		<ul>
			...
			<li class="goods_content" onclick="location.href='../ordersServlet?action=queryOneOrdersByOrd_idAndOrd_statueIsTrue&ord_id=${orders.ord_id}'" >		
				<div class="g_info">
					<table width="100%">
						<tr>
							...
							<td>								
									<span class="s_name">支付日期：${orders.ord_payTime }</span><br /><br />
									<span class="money">总金额：${orders.ord_totalPrice }元&nbsp;&nbsp;&nbsp;</span>
									<span class="money" onclick="location.href='../ordersServlet?action=queryOneOrdersById&ord_id=${orders.ord_id}'">支付&nbsp;&nbsp;</span>
									<br />
							</td>
						</tr>
					</table>
